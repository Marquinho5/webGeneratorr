...
if(mysqli_num_rows($resultado2)>0){
	while($f=mysqli_fetch_array($resultado2,MYSQLI_ASSOC)){
		if($f['idUsuario']==$_SESSION['idUsuario']){
			$listar.='<tr><td><a href="../'.$f["dominio"].'">'.$f["dominio"].'</a></td><td><a href="zip.php?zip='.$f["dominio"].'">Descargar web</a></td><td><a href="delete.php?dominio='.$f["dominio"].'">Eliminar web</a></td></tr>';
		}
	}
}
